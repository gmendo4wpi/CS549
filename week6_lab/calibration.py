...
image_files = glob.glob(image_folder + '\left*.jpg')  # Change the path accordingly
...
np.save('camera_matrix_part1.npy', camera_matrix)
np.save('dist_coeffs.npy_part1', dist_coeffs)
...
# Load a test image
test_image_path = r'C:\Users\Gio\desktop\tinyml\left01.jpg'  # Change the path to your test image if needed
...
np.save('reprojection_error_part1.npy', mean_error)
